...
const projects = [
  ...
  },
  {
    ...
    category: "Residential",
    description:
      "A tranquil bedroom retreat designed for ultimate relaxation, featuring soft textures, ambient lighting, and a calming neutral palette.",
  },
  {
    id: 5,
...
const Portfolio = () => {
  ...
  return (
    <Layout>
      <PageHeader
        title="Our Portfolio"
        subtitle="Explore our collection of thoughtfully designed spaces that showcase our commitment to excellence."
        ...
        <div className="container mx-auto">
          <div className="relative">
            ...
            <div className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden rounded-sm bg-muted">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                    ...
                    >
                      ...
                      <h3 className="text-2xl md:text-3xl lg:text-4xl font-serif text-primary-foreground mb-4">
              ...
              <button
                onClick={() => paginate(-1)}
                className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-background/80 hover:bg-background text-foreground rounded-full transition-colors duration-200 z-10"
              ...
              <button
                onClick={() => paginate(1)}
                className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-background/80 hover:bg-background text-foreground rounded-full transition-colors duration-200 z-10"
            ...
            <div className="flex justify-center gap-3 mt-8">
              {projects.map((project, index) => (
                <button
                  ...
                  className={`w-16 h-16 md:w-20 md:h-20 rounded-sm overflow-hidden transition-all duration-300 ${
                    index === currentIndex
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="group img-zoom cursor-pointer"
                onClick={() => goToSlide(index)}
              >
